-- National Team Kick Return Defense
SELECT 
...
select
    ...
    sum(tgs2.kickreturns) as "No",
    sum(tgs2.kickreturnyards) as yards,
    round(sum(tgs2.kickreturnyards) / sum(tgs2.kickreturns), 2) as avg,
    max(tgs2.kickreturnlong) as "long",
    sum(tgs2.kickreturntds) as "td" 
from
