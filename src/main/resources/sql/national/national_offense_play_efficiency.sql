...
play_count as (
	...
	all_plays.offenseteamid, 
	count(*) as total_plays
	from all_plays
	group by all_plays.Team, all_plays.offenseteamid 
),
fbs_teams as (
	select distinct all_plays.offenseteamid
	from all_plays
	join team on team.teamid = all_plays.offenseteamid 
...
select
	...
	play_count.Team, 
	play_count.offenseteamid as "TeamId",
...
join fbs_teams on fbs_teams.offenseteamid = play_count.offenseteamid 
