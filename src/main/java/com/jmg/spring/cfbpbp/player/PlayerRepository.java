...
public class PlayerRepository {
	...
	// List<Map<String, Object>> result; // safeguard against race condition. make
	// this a local variable instead of a class variable
	...
	public String getPlayerStats(String year, String sqlFile) throws IOException {
		...
		List<Map<String, Object>> result = jdbcTemplate.query(sql, mapper, year);
	...
	// Career totals - aggregated over all years, i.e. not by year but all time
	// stats
	...
	private String resultAsJson(String sqlFile, String playerId) throws IOException {
		String sql = SqlFileReader.getSqlFromFile(sqlFile);
		List<Map<String, Object>> result = jdbcTemplate.query(sql, mapper, playerId);
		String json = om.writeValueAsString(result);
		return json;
